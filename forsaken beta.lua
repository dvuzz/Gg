local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/vokamc/Orion/refs/heads/main/Open-source')))()
...
local Tab_Generators = Window:MakeTab({
    Name = "Generators",
    Icon = "rbxassetid://4483345998",
    PremiumOnly = false
})
...
local Tab_Stamina = Window:MakeTab({
    Name = "Stamina Settings",
    Icon = "rbxassetid://4483345998",
    PremiumOnly = false
})

local Tab_Aimbot = Window:MakeTab({
    Name = "Aimbot",
    Icon = "rbxassetid://4483345998",
    PremiumOnly = false
})
...
local Tab_AntiSlows = Window:MakeTab({
    Name = "Anti Slow",
    Icon = "rbxassetid://4483345998",
    PremiumOnly = false
})

local Tab_Achievements = Window:MakeTab({
    Name = "Achievements",
    Icon = "rbxassetid://4483345998",
    PremiumOnly = false
})
...
-- == UI Elements: Generators Tab ==
Tab_Generators:AddToggle({
...
-- === ESP Section: Main ESP ===
Tab_ESP:AddSection("Main ESP")
...
-- ESP Section: Builderman
Tab_ESP:AddSection("Builderman ESP")
Tab_ESP:AddToggle({
    Name = "Dispenser ESP",
    Default = false,
...
-- Aimbot Tab: Shedletsky
Tab_Aimbot:AddSection("Shedletsky")
Tab_Aimbot:AddToggle({
    Name = "Aimbot Slash",
...
-- Aimbot Tab: True One Shot
Tab_Aimbot:AddParagraph("True One Shot Aimbot", "For Chance True One Shot Only")
Tab_Aimbot:AddToggle({
...
-- Aimbot Tab: Guest 1337
Tab_Aimbot:AddSection("Guest 1337")
Tab_Aimbot:AddToggle({
    Name = "Aimbot Punch",
...
-- Aimbot Tab: AimMode
Tab_Aimbot:AddSection("AimMode")
Tab_Aimbot:AddDropdown({
    Name = "Aim Mode",
...
-- Create Anti-Slow Toggles
for name, config in pairs(AntiSlowConfigs) do
    Tab_AntiSlows:AddToggle({
        Name = "Anti-Slow " .. name,
        Default = false,
        Callback = function(value)
            if value then
...
-- Combat Tab: c00lkidd Section
Tab_Combat:AddSection("c00lkidd")
...
-- Combat Tab: Noli Section
Tab_Combat:AddSection("Noli")
Tab_Combat:AddToggle({
...
-- Combat Tab: Dusekkar Section
Tab_Combat:AddSection("Dusekkar")
Tab_Combat:AddToggle({
...
Tab_Combat:AddSection("Blindness")
Tab_Combat:AddToggle({
    Name = "Anti Blindness",
    Default = false,
    Callback = function(value)
...
-- Combat Tab: Chance Section
Tab_Combat:AddSection("Chance")
Tab_Combat:AddToggle({
    Name = "Auto CoinFlip",
    Default = false,
    Callback = function(value)
...
Tab_Combat:AddSection("Guest 1337 -- Charge")
Tab_Combat:AddToggle({
...
-- Combat Tab: Two Time Section
Tab_Combat:AddSection("Two Time")
Tab_Combat:AddToggle({
    Name = "Auto Backstab",
    Default = false,
    Callback = function(value)
...
-- Combat Tab: Guest 1337 --- Auto Block & Punch
getgenv().ReplicatedStorage = game:GetService("ReplicatedStorage")
getgenv().TweenService = game:GetService("TweenService")
getgenv().RunService = game:GetService("RunService")
getgenv().Players = game:GetService("Players")
...
-- Combat Tab: Guest 1337 --- Auto Block Section
Tab_Combat:AddSection("Guest 1337 --- Auto Block")
Tab_Combat:AddToggle({
...
-- Combat Tab: Guest 1337 --- Auto Punch Section
Tab_Combat:AddSection("Guest 1337 --- Auto Punch")
Tab_Combat:AddToggle({
    Name = "Auto Punch",
    Default = false,
...
-- Auto Block & Punch Logic (Unchanged)
...
-- Combat Tab: Guest 1337 --- Auto Block Section (Continued)
Tab_Combat:AddToggle({
    Name = "Radius Visual",
    Default = false,
    Callback = function(state)
...
-- Auto Block & Punch Helper Functions
...
-- Sound Auto Block Logic (Unchanged)
getgenv().soundHooks = {}
...
-- Combat Tab: Killers Parry Section
Tab_Combat:AddSection("Killers Parry")
Tab_Combat:AddToggle({
...
-- Misc Tab: Device Section
Tab_Misc:AddSection("Device")
Tab_Misc:AddDropdown({
    Name = "Spoof Device",
    Default = getgenv().device,
...
-- Misc Tab: Invisibility
Tab_Misc:AddSection("Invisibility")
...
Tab_Misc:AddToggle({
    ...
    Callback = function(Value)
        ...
        if not humanoid or humanoid.RigType ~= Enum.HumanoidRigType.R6 then
            warn("This only works with R6 rig!")
            return
        end
        if Value then
...
Tab_Misc:AddSection("Animations")
Tab_Misc:AddToggle({
...
-- Misc Tab: Last Man Standing (LMS)
...
-- Misc Tab: Last Man Standing Section
Tab_Misc:AddSection("Last Man Standing")
Tab_Misc:AddToggle({
...
Tab_Achievements:AddSection("Fun")
Tab_Achievements:AddButton({
...
-- Combat Tab: Invisible Effect Section
Tab_Combat:AddSection("Invisible Effect")
Tab_Combat:AddToggle({
